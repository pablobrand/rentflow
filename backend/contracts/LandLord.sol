...
contract LandLord is Ownable, KeeperCompatibleInterface {
    ...
    */
    ...
    constructor(uint updateInterval, address _tokenUsedToPay, address _lendingService) {
    ...
    function transfer_to_aave(uint256 amount) internal  {
        
        tokenUsedForPayments.approve(address(lendingService), amount);
    }
}
